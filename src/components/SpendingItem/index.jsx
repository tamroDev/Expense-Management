...
function SpendingItem({ src, name, id, hidden }, ref) {
  return (
    <div
      ref={ref}
      className="rounded-2xl flex-[25%] w-[33%] max-w-[30%] max-h-[150px] flex justify-center items-center flex-col border shadow-xl p-1 py-2 gap-3 cursor-pointer relative"
    >
      {!hidden && (
