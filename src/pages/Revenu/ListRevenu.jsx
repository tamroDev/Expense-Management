...
import {
  deleteRevenu,
  getRevenu,
} from "../../redux/reduxSlices/revenuSlice.js";
...
import { settingRevenu } from "./settingRevenu.js";
...
function ListRevenu() {
  ...
  useEffect(() => {
    dispatch(getRevenu(_id));
  }, [dispatch, _id]);

  const { revenuList } = useSelector((state) => state.revenu);

  const newArr = mergeExpensesWithSettings(revenuList, settingRevenu);
